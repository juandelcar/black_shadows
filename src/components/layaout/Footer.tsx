            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3">
                  <li>
                    <Link to="/views/About" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 flex items-center">
                  ...
                  <li>
                    <Link to="/views/Contact" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 flex items-center">
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <p className="text-gray-400 text-sm">
                Desarrollado con ❤️ por Black Shadows Team
              </p>
            </div>
          </div>
        </div>
