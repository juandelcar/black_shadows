            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4 transform hover:scale-105 transition-transform duration-300">
                ...
                <div className="flex space-x-6">
                  {/* Facebook Icon */}
                  <a href="#" className="text-gray-400 hover:text-blue-400 transition-all duration-300 transform hover:scale-110 hover:rotate-3">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-blue-400">Contacto</h3>
                <ul className="space-y-3">
                  <li>
                    <Link to="/views/About" className="text-gray-300 hover:text-blue-400 transition-all duration-300 flex items-center group">
                      <svg className="w-6 h-6 mr-3 text-blue-400 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <li>
                    <Link to="/views/Contact" className="text-gray-300 hover:text-blue-400 transition-all duration-300 flex items-center group">
                      <svg className="w-6 h-6 mr-3 text-blue-400 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
